...
def main() -> None:
    ...
    if args.top_k:
        report.update({"top_k": args.top_k, "micro_f1_top_k": multilabel_top_k_f1(targets, probabilities, args.top_k), "macro_f1_top_k": multilabel_top_k_f1(targets, probabilities, args.top_k, average="macro")})
