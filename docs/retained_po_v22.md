...
Version 22 completed from commit `519ae6cecadb30e4339d6fcf5354c4f0ed19f479` in **2.303860 hours**. Both notebook test passes and the independent output validator succeeded. The registered primary retained-PO mixture scored 0.3247592104 on the pooled internal cross-fit assessment versus 0.3241891884 for matched frozen v21, a gain of 0.0005700220 with spatial-block-bootstrap 95% CI [0.0000946736, 0.0012829566]. It improved over v21 in each fold and passed every registered submission criterion. All 14,479 assessment rows and 64 blocks were independently reproduced from the saved per-survey output.

The single-head ablation scored 0.3248939718, 0.0001347614 above retained-PO at the point estimate, but the retained-minus-single interval [-0.0005969007, 0.0003654332] crosses zero. It was diagnostic and not eligible to replace the preregistered primary candidate after assessment. The result does not establish that the retention loss improved over ordinary PO initialization. Production selected a uniform 2.5% retained-PO addition to exact frozen v21.

Exactly one official submission, ref `56233226`, scored **0.21684 public / 0.19491 private**. This is +0.00051 public and +0.00065 private over v21, leaving 0.03529 to the 0.2302 target. The result is the repository's current best but does not establish SOTA. The assessment is consumed and may not be reused as untouched evidence.
