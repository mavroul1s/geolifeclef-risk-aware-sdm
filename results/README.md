...
- `v29_summary.json` records the current official best: public 0.23900 / private 0.21093, completed in 3.0142 hours on T4.
- `v29_kaggle_output/` contains its four original files; `v29_kaggle_scores.png` preserves the screenshot. V29 passed its submission gate.
- `v27_summary.json` records the previous official best: public 0.23339 and private 0.20831 (the historical summary's status is as of its recording date).
